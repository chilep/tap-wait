package
{
    public class AssetEmbeds_1x
    {
		...
		[Embed(source = "../media/textures/1x/buttons/simple/up.png")]
        public static const BtnSimpleUp:Class;
		
        [Embed(source = "../media/textures/1x/buttons/simple/down.png")]
        public static const BtnSimpleDown:Class;
